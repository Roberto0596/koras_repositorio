		...
		static public function ctrIngresoUsuario()
		{
			if (isset($_POST["ingUsuario"])) 
			{
				if (preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingUsuario"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingContraseña"])) 
				{
					...
					if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $_POST["ingContraseña"])
					{
			...
			if (isset($_POST["nuevoUsuario"]))
		 	{
				if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]))
				{
					...
					$tabla = "usuarios";
					//$encriptacion = crypt($_POS["nuevoPassword"], '$2a$07$asxx54ahjppf45sd87a5a4dDDGsystemdev$');
